...
$RootPath = "C:\temp\Launcher"
$AppPath = "C:\temp\Launcher\Logs\ADTool"
...
$frmInitialScreen.Text = 'AD-Tool Auditor By Olirwan 2017'
...
Try{
    ...
    ("-~-") | Out-File $AppPath$LogFile -Append
    cls
    Write-Host "Loaded All Active Directory Modules" -ForegroundColor Cyan
    Sleep 2
