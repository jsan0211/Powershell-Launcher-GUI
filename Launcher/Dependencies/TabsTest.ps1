...
$RemotingPage = New-Object System.Windows.Forms.TabPage
...
$TroubleshootingPage.Name = "SQLHealthPage"
$TroubleshootingPage.Text = "SQL Health Check”
$TroubleshootingPage.Controls.Add($SQLHealthPage)

#CPU Page
$RemotingPage.DataBindings.DefaultDataSourceUpdateMode = 0
$RemotingPage.UseVisualStyleBackColor = $True
$RemotingPage.Name = "CPUPage"
$RemotingPage.Text = "CPU”
